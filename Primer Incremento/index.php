...
<body>
	...
	<div class="container">
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner" role="listbox" style="height: 420px !important">
		    <div class="item active">
		      <img src="inicio/banner/1.png" style="height: 420px !important; width: 100%">
		    </div>
		    <div class="item">
		      <img src="inicio/banner/2.png" style="height: 420px !important; width: 100%">
		    </div>
		    <div class="item">
		      <img src="inicio/banner/3.png" style="height: 420px !important; width: 100%">
		    </div>
		    <div class="item">
		      <img src="inicio/banner/4.png" style="height: 420px !important; width: 100%">
		    </div>
		    <div class="item">
		      <img src="inicio/banner/5.png" style="height: 420px !important; width: 100%">
		    </div>
		  </div>
		  <!-- Controls -->
		...
		<h1 align="center">Especialidad</h1><hr>
		<div class="container">
			...
			<div class="col-xs-3" style="text-align: center; "ng-repeat="Medico in ListaMedicos | filter:Buscar | limitTo:10"  >
				<div class="panel panel-primary" >
					...
					<div class="panel-body">								
					 	...
					 	<p class="card-text">{{Medico.Descripcion}}<br>
					</div>						
				</div>
			</div>
		</div>			
